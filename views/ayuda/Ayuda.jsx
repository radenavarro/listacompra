    ...
    <ImageBackground source={require('../../img/image-3ucottvo.png')} resizeMode='repeat'>
      <ScrollView contentContainerStyle={styles.wrapper}>
        <View style={[styles.container]}>
          ...
          <Text style={[styles.defaultFontStyle, styles.alignLeft]}>Es la pantalla donde se pueden crear listas con productos y archivarlas cuando estén finalizadas.</Text>
          <Text style={[styles.h2, styles.spacer]}>Botonera superior</Text>
          <Text style={[styles.defaultFontStyle, styles.alignLeft]}>
          ...
          <Text style={[styles.bold, styles.alignLeft, styles.subItem, styles.spacerHalf]}>Nueva lista: </Text>
          <Text style={[styles.defaultFontStyle, styles.alignLeft]}>
            Elimina la lista actual. El efecto es el mismo que si eliminaramos los productos a mano 1 por 1.
          </Text>
          <Text style={[styles.bold, styles.alignLeft, styles.subItem, styles.spacerHalf]}>Limpiar campos: </Text>
          <Text style={[styles.defaultFontStyle, styles.alignLeft]}>
          ...
          <Text style={[styles.bold, styles.alignLeft, styles.subItem, styles.spacerHalf]}>Archivar lista: </Text>
          <Text style={[styles.defaultFontStyle, styles.alignLeft]}>
          ...
          <Text style={[styles.h2, styles.spacer]}>Sección para añadir productos</Text>
          <Text style={[styles.defaultFontStyle, styles.alignLeft]}>
          ...
          <Text style={[styles.bold, styles.alignLeft, styles.subItem, styles.spacerHalf]}>Campo de producto: </Text>
          <Text style={[styles.defaultFontStyle, styles.alignLeft]}>
          ...
          <Text style={[styles.bold, styles.alignLeft, styles.subItem, styles.spacerHalf]}>Campo de cantidad: </Text>
          <Text style={[styles.defaultFontStyle, styles.alignLeft]}>
          ...
          <Text style={[styles.bold, styles.alignLeft, styles.subItem, styles.spacerHalf]}>Botón de micrófono: </Text>
          <Text style={[styles.defaultFontStyle, styles.alignLeft]}>
          ...
          <Text style={[styles.defaultFontStyle, styles.alignLeft, styles.spacerHalf]}>
          ...
          <Text style={[styles.bold, styles.alignLeft, styles.subItem, styles.spacerHalf]}>Botón de añadir: </Text>
          <Text style={[styles.defaultFontStyle, styles.alignLeft]}>
          ...
          <Text style={[styles.h2, styles.spacerHalf]}>Sección de productos de la lista de la compra</Text>
          <Text style={[styles.defaultFontStyle, styles.alignLeft, styles.spacerHalf]}>
          ...
          <Text style={[styles.defaultFontStyle, styles.alignLeft, styles.spacerHalf]}>
            Además, también puedes modificar las cantidades de cada producto moviendo su renglón correspondiente hacia la izquierda.
            Eso mostrará un botón que te permitirá añadir la nueva cantidad.
          </Text>
          {/* SECCIÓN ARCHIVO */}
          <Text style={[styles.h1, styles.spacer]}>Archivo</Text>
          <Text style={[styles.defaultFontStyle, styles.alignLeft]}>
          ...
          {/* SECCIÓN STOCK */}
          <Text style={[styles.h1, styles.spacer]}>Stock</Text>
          <Text style={[styles.defaultFontStyle, styles.alignLeft]}>
